...
function createDirectionPane(relatedData: IDirectionalRelatedData) {
  ...
  genericDisclaimer.textContent =
    "Minimum clearances shown relative to the travel direction for each lane, with lanes numbered from left to right. (Camera angle may not display all lanes in line with roadway in the photo.) Minimum shoulder clearances not shown, but may be posted on structure.";
